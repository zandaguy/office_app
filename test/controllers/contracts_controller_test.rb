...
class ContractsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contract" do
    assert_difference('Contract.count') do
      post contracts_url, params: { contract: { paid_or_not: @contract.paid_or_not, start_date: @contract.start_date } }
    end
  ...
  test "should update contract" do
    patch contract_url(@contract), params: { contract: { paid_or_not: @contract.paid_or_not, start_date: @contract.start_date } }
